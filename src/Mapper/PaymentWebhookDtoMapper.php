...
namespace BlackCat\Database\Packages\PaymentWebhooks\Mapper;

use BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto;
use BlackCat\Database\Packages\PaymentWebhooks\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO PaymentWebhookDto:
...
final class PaymentWebhookDtoMapper
{
     ...
     */
    public static function fromRow(array $row): PaymentWebhookDto
    {
        /** @var PaymentWebhookDto */
    ...
    public static function fromRowOrNull(?array $row): ?PaymentWebhookDto
    {
     ...
     *
     * @param PaymentWebhookDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(PaymentWebhookDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(PaymentWebhookDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(PaymentWebhookDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,PaymentWebhookDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,PaymentWebhookDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(PaymentWebhookDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,PaymentWebhookDto>
     */
