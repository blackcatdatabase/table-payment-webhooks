...
{
    private PaymentWebhookRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new PaymentWebhookRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto|null
    {
