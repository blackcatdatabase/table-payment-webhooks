...
use BlackCat\Database\Packages\PaymentWebhooks\Repository\PaymentWebhookRepository as GeneratedRepository;
...
{
  private PaymentWebhookRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof PaymentWebhookRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected PaymentWebhookRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\PaymentWebhooks\Dto\PaymentWebhookDto|null { return $this->repo->getById($id, $asDto); }
