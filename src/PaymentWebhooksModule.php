...
final class PaymentWebhooksModule implements ModuleInterface {
    ...
    public function name(): string { return 'table-payment_webhooks'; }
    public function table(): string { return 'payment_webhooks'; }
    ...
    public function status(Database $db, SqlDialect $d): array {
        ...
        $fks     = [ 'fk_payment_webhooks_payment' ];
        $missingIdx = [];
        $missingFk  = [];
