...
| Pkg folder | [packages\payment-webhooks](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\payment-webhooks) | Repo location |
...
graph LR
  ...
  payment_webhooks["payment_webhooks"]:::center
  payment_webhooks -->|FK| payments["payments"]:::link
...
- `from_cache` – default=mysql: 0 / postgres: FALSE
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payment-webhooks -Apply
