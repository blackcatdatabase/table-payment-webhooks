...
- Pkg folder: [packages\payment-webhooks](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\payment-webhooks)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package payment-webhooks -Apply
